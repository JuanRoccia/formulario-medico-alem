        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function downloadForms() {
                forms.forEach((form, index) => {
                    ...
                    // Convert to PDF
                    html2pdf().from(iframeContent).save(`form_${index + 1}.pdf`);
...
Cuando hay un solo formulario en vez de siguiente deberia decir finalizar ya que no hay mas formularios por llenar, y al darle finalizar deberia descargar los formularios en formato PDF y jpg y enviarlos por whatsapp.